...
describe('ProductoPedido e2e test', () => {
  ...
  it('should load ProductoPedidos', async () => {
    ...
    expect(await productoPedidoComponentsPage.getTitle()).to.eq('mitiendaonlineApp.productoPedido.home.title');
    await browser.wait(
  ...
  it('should load create ProductoPedido page', async () => {
    ...
    expect(await productoPedidoUpdatePage.getPageTitle()).to.eq('mitiendaonlineApp.productoPedido.home.createOrEditLabel');
  ...
  /* it('should delete last ProductoPedido', async () => {
        ...
        expect(await productoPedidoDeleteDialog.getDialogTitle())
            .to.eq('mitiendaonlineApp.productoPedido.delete.question');
