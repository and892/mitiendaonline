...
describe('Sucursal e2e test', () => {
  ...
  it('should load Sucursals', async () => {
    ...
    expect(await sucursalComponentsPage.getTitle()).to.eq('mitiendaonlineApp.sucursal.home.title');
  ...
  it('should load create Sucursal page', async () => {
    ...
    expect(await sucursalUpdatePage.getPageTitle()).to.eq('mitiendaonlineApp.sucursal.home.createOrEditLabel');
  ...
  it('should delete last Sucursal', async () => {
    ...
    expect(await sucursalDeleteDialog.getDialogTitle()).to.eq('mitiendaonlineApp.sucursal.delete.question');
