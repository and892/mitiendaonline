...
describe('Producto e2e test', () => {
  ...
  it('should load Productos', async () => {
    ...
    expect(await productoComponentsPage.getTitle()).to.eq('mitiendaonlineApp.producto.home.title');
  ...
  it('should load create Producto page', async () => {
    ...
    expect(await productoUpdatePage.getPageTitle()).to.eq('mitiendaonlineApp.producto.home.createOrEditLabel');
  ...
  /* it('should delete last Producto', async () => {
        ...
        expect(await productoDeleteDialog.getDialogTitle())
            .to.eq('mitiendaonlineApp.producto.delete.question');
