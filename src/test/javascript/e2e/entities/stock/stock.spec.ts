...
describe('Stock e2e test', () => {
  ...
  it('should load Stocks', async () => {
    ...
    expect(await stockComponentsPage.getTitle()).to.eq('mitiendaonlineApp.stock.home.title');
  ...
  it('should load create Stock page', async () => {
    ...
    expect(await stockUpdatePage.getPageTitle()).to.eq('mitiendaonlineApp.stock.home.createOrEditLabel');
  ...
  it('should delete last Stock', async () => {
    ...
    expect(await stockDeleteDialog.getDialogTitle()).to.eq('mitiendaonlineApp.stock.delete.question');
