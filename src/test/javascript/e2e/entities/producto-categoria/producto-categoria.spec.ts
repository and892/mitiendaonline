...
describe('ProductoCategoria e2e test', () => {
  ...
  it('should load ProductoCategorias', async () => {
    ...
    expect(await productoCategoriaComponentsPage.getTitle()).to.eq('mitiendaonlineApp.productoCategoria.home.title');
    await browser.wait(
  ...
  it('should load create ProductoCategoria page', async () => {
    ...
    expect(await productoCategoriaUpdatePage.getPageTitle()).to.eq('mitiendaonlineApp.productoCategoria.home.createOrEditLabel');
  ...
  it('should delete last ProductoCategoria', async () => {
    ...
    expect(await productoCategoriaDeleteDialog.getDialogTitle()).to.eq('mitiendaonlineApp.productoCategoria.delete.question');
