...
describe('Pedido e2e test', () => {
  ...
  it('should load Pedidos', async () => {
    ...
    expect(await pedidoComponentsPage.getTitle()).to.eq('mitiendaonlineApp.pedido.home.title');
  ...
  it('should load create Pedido page', async () => {
    ...
    expect(await pedidoUpdatePage.getPageTitle()).to.eq('mitiendaonlineApp.pedido.home.createOrEditLabel');
  ...
  /* it('should delete last Pedido', async () => {
        ...
        expect(await pedidoDeleteDialog.getDialogTitle())
            .to.eq('mitiendaonlineApp.pedido.delete.question');
