...
describe('Envio e2e test', () => {
  ...
  it('should load Envios', async () => {
    ...
    expect(await envioComponentsPage.getTitle()).to.eq('mitiendaonlineApp.envio.home.title');
  ...
  it('should load create Envio page', async () => {
    ...
    expect(await envioUpdatePage.getPageTitle()).to.eq('mitiendaonlineApp.envio.home.createOrEditLabel');
  ...
  it('should delete last Envio', async () => {
    ...
    expect(await envioDeleteDialog.getDialogTitle()).to.eq('mitiendaonlineApp.envio.delete.question');
