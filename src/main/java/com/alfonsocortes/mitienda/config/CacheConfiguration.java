package com.alfonsocortes.mitienda.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("mitiendaonline");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("mitiendaonline");
        ...
        config.getMapConfigs().put("com.alfonsocortes.mitienda.domain.*", initializeDomainMapConfig(jHipsterProperties));
